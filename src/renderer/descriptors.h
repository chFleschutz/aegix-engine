...
namespace vre
{
    ...
    public:
        ...
        {
        public:
            Builder(VulkanDevice& device) : mVreDevice{ device } {}
        ...
        VreDescriptorSetLayout(VulkanDevice& lveDevice, std::unordered_map<uint32_t, VkDescriptorSetLayoutBinding> bindings);
