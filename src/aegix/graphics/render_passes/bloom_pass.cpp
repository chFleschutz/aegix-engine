...
namespace Aegix::Graphics
{
		...
		: m_sampler{ device }
	{
		...
		m_thresholdPipeline = Pipeline::ComputeBuilder{ device }
		...
		m_downsamplePipeline = Pipeline::ComputeBuilder{ device }
		...
		m_upsamplePipeline = Pipeline::ComputeBuilder{ device }
