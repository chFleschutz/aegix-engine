...
{
	void CameraController::calcViewMatrix(Component::Camera& camera, Component::Transform& transform)
	{
	...
	void CameraController::calcPerspectiveProjection(Component::Camera& camera)
	{
